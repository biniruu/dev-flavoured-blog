---
title: Can't find Node.js binary node ... 에러 해결 방법
date: 2024-01-18
...
그런데 node가 설치되는 경로는 뻔할 텐데 왜 못 찾을까 궁금해서 검색해 보니 nvm이나 n처럼 node 버전 관리 도구를 사용할 경우에 발생할 수 있는 문제인 듯하더라고요. 기술적인 문제는 아닌 듯해서 다행이에요.🙌🏻
